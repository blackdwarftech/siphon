...
class LLM(ClientWrapperMixin):
    """Perplexity-backed LLM wrapper for LiveKit's OpenAI-compatible plugin."""
    def __init__(
        self,
        model: Optional[str] = "llama-3.1-sonar-small-128k-chat",
    ...
    def from_config(cls, cfg: dict) -> "LLM":
        return cls(
            model=cfg.get("model", "llama-3.1-sonar-small-128k-chat"),
